        ...
        <div className="py-48 flex flex-col items-center justify-center">
          ...
          <div className=" text-center px-4 space-y-7">
            ...
            <p className="text-[#4A4A4A] text-xl md:w-4/5 mx-auto">
              Come with your family and experience the thrill of exquisite meals
              such as Delicious Rice Bowls, Quality Burgers, Rich Desserts,
              Refreshing Drinks and more at a low cost.
            </p>
      ...
      <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4">
        <div className="flex flex-col md:flex-row flex-wrap md:justify-between items-center space-y-3 mb-8">
          ...
          <div className="flex flex-row justify-start md:items-center md:gap-8 gap-4  flex-wrap">
            ...
            <button
              onClick={() => filterItems("ricebowl")}
              className={selectedCategory === "ricebowl" ? "active" : ""}
            >
              Rice Bowls
            </button>
            <button
